...
ActiveRecord::Schema[7.0].define(version: 20_230_917_094_255) do
  ...
  create_table 'comee_core_client_prices', force: :cascade do |t|
    ...
    t.index %w[product_id client_id], name: 'index_comee_core_client_prices_on_product_id_and_client_id',
                                      unique: true
  ...
  create_table 'comee_core_master_prices', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[product_id supplier_id], name: 'index_comee_core_master_prices_on_product_id_and_supplier_id',
                                        unique: true
  ...
  create_table 'comee_core_notifications', force: :cascade do |t|
    ...
    t.index %w[recipient_type recipient_id], name: 'index_comee_core_notifications_on_recipient'
  end
  ...
  create_table 'comee_core_product_lookups', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[itemable_id itemable_type product_id], name: 'itemable_product_indx_uniq', unique: true
    t.index %w[itemable_type itemable_id], name: 'index_comee_core_product_lookups_on_itemable'
