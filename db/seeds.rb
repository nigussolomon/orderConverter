...
puts "creating users"
admin_user = Comee::Core::User.where(name: "MAVEKO ADMIN", email: "maveko.admin@test.com", user_type: 1, password_digest: BCrypt::Password.create("maveko23#")).first_or_create
hepp_user = Comee::Core::User.where(name: "HEPP", email: "nigussolomon444@gmail.com", user_type: 0, password_digest: BCrypt::Password.create("maveko23#")).first_or_create
mafter_user = Comee::Core::User.where(name: "MAFTER", email: "mafter.admin@test.com", user_type: 0, password_digest: BCrypt::Password.create("maveko23#")).first_or_create
contacto_user = Comee::Core::User.where(name: "CONTACTO", email: "contacto.admin@test.com", user_type: 0, password_digest: BCrypt::Password.create("maveko23#")).first_or_create
client_user = Comee::Core::User.where(name: "AZAMARA", email: "azamara.admin@test.com", user_type: 0, password_digest: BCrypt::Password.create("maveko23#")).first_or_create

puts "creating suppliers"
supplier_hepp = Comee::Core::Supplier.where(code: "SP1231", name: "HEPP", address: "Germany", user_id: hepp_user.id).first_or_create
supplier_mafter = Comee::Core::Supplier.where(code: "SP1232", name: "MAFTER", address: "Germany", user_id: mafter_user.id).first_or_create
supplier_contacto = Comee::Core::Supplier.where(code: "SP1233", name: "CONTACTO", address: "Germany", user_id: contacto_user.id).first_or_create

puts "creating clients"
client_azamara = Comee::Core::Client.where(code: "CL1122", user_id: client_user.id, name: "AZAMARA", address: "Germany").first_or_create
